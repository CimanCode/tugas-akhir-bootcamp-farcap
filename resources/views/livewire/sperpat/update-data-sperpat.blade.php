...
<div>
    <div class="w-[900px] mx-auto shadow-lg rounded-md mt-10 p-10">
        ...
        <div class="flex-col mt-8 bg-slate-500]">
            <form action="{{ route('updateDataSperpat', $dataSperpat->id) }}" method="post" enctype="multipart/form-data" class="w-[500px] mx-auto">
                @method('put')
                @csrf
                ...
                <div class="flex-col">
                    ...
                    value="{{ $dataSperpat->nama_sperpat }}">
                </div>
                <div class="flex-col">
                    <div class="mt-2 mb-2">
                ...
                <div class="flex-col">
                    ...
                    class="border-2 w-[500px] rounded-md p-2 focus:outline-cyan-600"
                    value="{{ $dataSperpat->harga_sperpat }}">
                </div>
                <br>
                <div class="bg-cyan-600 p-2 text-center text-white rounded-md mx-auto">
